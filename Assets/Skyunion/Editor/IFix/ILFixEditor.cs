    ...
    public class IFixEditor
    {
        ...
        public static void InjectAssembly(string assembly)
        {
            ...
            if (hasSomethingToDo)
            {
                ...
                var core_path = "./Assets/Skyunion/RunTime/HotFixService/IFix/Plugins/IFix.Core.dll";
        ...
        public static void GenPlatformPatch(Platform platform, string patchOutputDir,
            string corePath = "./Assets/Skyunion/RunTime/HotFixService/IFix/Plugins/IFix.Core.dll")
        {
            ...
            foreach (var assembly in injectAssemblys)
            {
                GenPatch(assembly, string.Format("{0}/{1}.dll", outputDir, assembly),
                    "./Assets/Skyunion/RunTime/HotFixService/IFix/Plugins/IFix.Core.dll", string.Format("{0}{1}.patch.bytes", patchOutputDir, assembly));
            }
#else
        ...
        public static void GenPatch(string assembly, string assemblyCSharpPath
            ...
            string corePath = "./Assets/Skyunion/RunTime/HotFixService/IFix/Plugins/IFix.Core.dll", string patchPath = "Assembly-CSharp.patch.bytes")
        {
        ...
        public static void Patch()
        {
            ...
            try
            {
                foreach (var assembly in injectAssemblys)
                {
                    ...
                    GenPatch(assembly, assembly_path, "./Assets/Skyunion/RunTime/HotFixService/IFix/Plugins/IFix.Core.dll",
                        string.Format("./Assets/StreamingAssets/{0}.patch.bytes", assembly));
                }
            }
            catch (Exception e)
            {
        ...
        public static void PatchNotProgressBar()
        {
            try
            {
                foreach (var assembly in injectAssemblys)
