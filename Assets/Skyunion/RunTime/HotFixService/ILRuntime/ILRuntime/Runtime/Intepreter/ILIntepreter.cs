                                            ...
                                            if (!processed)
                                            {
                                                if (code == OpCodeEnum.Callvirt)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        ilm = ins.Type.GetVirtualMethod(ilm) as ILMethod;
                                                    }
                                                }
                            ...
                            case OpCodeEnum.Ldfld:
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (obj != null)
                                        {
                                            ...
                                            // modify by Johance 需要处理 
                                            else if (obj is CrossBindingAdaptorType)
                                            {
                                                ILTypeInstance instance = ((CrossBindingAdaptorType)obj).ILInstance;
                                                instance.PushToStack((int)ip->TokenLong, ret, this, mStack);
                                            }
                                            else
                                            {
