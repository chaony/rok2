...
namespace Skyunion {
	...
	public class ViewBinder : BehaviourBinder {
        ...
        /// 按返回键回调
        /// </summary>
        public System.Func<bool> onMenuBackCallback;
        /// <summary>
        /// 窗口表现完关闭动画后回调
        /// </summary>
        public System.Action onCloseAnimatorCallback;
        /// <summary>
        /// 是否正处于关闭动画表现中
        /// </summary>
        public bool IsAniCloseing = false;
        ...
        public void CloseAnimatorCallback()
        {
            if (onCloseAnimatorCallback != null)
            {
                onCloseAnimatorCallback();
            }
            IsAniCloseing = false;
        }
        ...
        {
            if (onMenuBackCallback != null)
            {
                return onMenuBackCallback();
            }
            return false;
        }
    }
