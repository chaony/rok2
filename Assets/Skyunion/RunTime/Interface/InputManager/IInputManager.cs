...
namespace Skyunion
{
    public interface IInputManager : IModule
    {
        ...
        int GetTouchCount();
        void AddTouchEvent(Action<int, int> eventOnToucheBegin, Action<int, int> eventOnToucheMove, Action<int, int> eventOnToucheEnd);
        void RemoveTouchEvent(Action<int, int> eventOnToucheBegin, Action<int, int> eventOnToucheMove, Action<int, int> eventOnToucheEnd);
        ...
        RaycastHit[] RayCashHit3D(int x, int y, out int nIndex);
    }
}
