...
namespace Skyunion
{
    public class Crypt
    {
        ...
        //        {
        //            UInt32 X = new UInt32(), Y = new UInt32();
        //
        ...
        //            {
        //                byte[] outbuffer = ArrayPool<byte>.Shared.Rent(8);
        //                byte[] intbuffer = ArrayPool<byte>.Shared.Rent(8);
        //                for (int k = 0; k < 8; k++)
        //                {
        //                    intbuffer[k] = text[i + k];
        //                }
        ...
        //                ArrayPool<byte>.Shared.Return(intbuffer,true);
        //
        //            }
        //            int padding = 1;
