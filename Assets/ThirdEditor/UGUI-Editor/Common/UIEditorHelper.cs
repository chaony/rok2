...
namespace U3DExtends
{
    public static class UIEditorHelper
    {
        ...
        static public Transform GetContainerUnderMouse(Vector3 mouse_abs_pos, GameObject ignore_obj = null)
        {
            ...
            RectTransform[] containers = Transform.FindObjectsOfType<RectTransform>();
...
//                    Debug.LogFormat("{0} {1} {2} {3} {4} {5} {6} {7} {8}",corners[0],corners[1],corners[2],corners[3],trans.gameObject.name,trans.anchorMin.x , trans.anchorMax.x , trans.anchorMin.y , trans.anchorMax.y);
        ...
        static public UnityEngine.Object GUIDToObject(string guid)
        {
            ...
            if (s_GetInstanceIDFromGUID == null)
                s_GetInstanceIDFromGUID = typeof(AssetDatabase).GetMethod("GetMainAssetInstanceID",
                    BindingFlags.Static | BindingFlags.NonPublic);
...
//                    {
                        ...
                        GUI.TextField(new Rect(0, tex.height, tex.width, tex.height+30),"ssdf");
//                    }
//                }
            }
            GUI.EndGroup();
        ...
        static public Transform GetGoodContainer(Transform trans)
        {
            if (trans == null)
                return null;
